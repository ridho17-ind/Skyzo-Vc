...
buttons = [
    [
        InlineKeyboardButton('Support', url='https://t.me/flicksrobotsupport'),
...
async def search(client, query):
    ...
    if query.query == "ETHO_ORUTHAN_PM_VANNU":
        answers.append(
            InlineQueryResultArticle(
                title="Deploy",
                input_message_content=InputTextMessageContent(f"{Config.REPLY_MESSAGE}\n\n<b>You can't use this bot in your group, for that you have to make your own bot from the [SOURCE CODE](https://github.com/ridho17-ind/Skyzo-Vc) below.</b>", disable_web_page_preview=True),
